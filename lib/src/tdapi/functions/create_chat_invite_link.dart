...
class CreateChatInviteLink extends TdFunction {
  ...
  CreateChatInviteLink({this.chatId, this.expireDate, this.memberLimit});
  ...
  /// [memberLimit] Maximum number of chat members that can join the chat by the link simultaneously; 0-99999; pass 0 if not limited
  int memberLimit;
