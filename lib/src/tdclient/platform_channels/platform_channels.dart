...
import 'package:td/src/tdapi/tdapi.dart'
...
class TdlibPlatformWrapper {
  ...
  static Future<void> destroyClient() async =>
      await _platform.invokeMethod('clientDestroy');

  /// Sends request to the TDLib client. May be called from any thread.
  static Future<void> clientSend(TdFunction event) async =>
      await _platform.invokeMethod(
          'clientSend', <String, dynamic>{'query': json.encode(event)});
  ...
  static Stream<TdObject> clientEvents() {
  ...
  static Future<TdObject> clientExecute(TdFunction event) async =>
